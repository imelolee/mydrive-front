            ...
            <el-form class="login-register" :model="formData" :rules="rules" ref="formDataRef">
                ...
                <div v-if="opType == 0 || opType == 2">
                    ...
                    <el-form-item prop="nickName" v-if="opType == 0">
                        <el-input size="large" clearable placeholder="ニックネーム" v-model.trim="formData.nickName"
                            maxLength="20">
                            <template #prefix>
                                <span class="iconfont icon-account"></span>
                            </template>
                    ...
                    <el-form-item prop="registerPassword">
                        <el-input type="password" size="large" clearable placeholder="パスワード"
                            v-model.trim="formData.registerPassword" maxLength="20" show-password>
                            <template #prefix>
                                <span class="iconfont icon-password"></span>
                            </template>
                        </el-input>
